...
Superset is currently being incubated at [the Apache Software Foundation](https://www.apache.org/theapacheway/index.html). The core contributors (or committers) to Superset communicate primarily in the following channels (all of which you can join):
...
[described in CONTRIBUTING.MD](https://github.com/apache/incubator-superset/blob/master/CONTRIBUTING.md) to get started. Here are some helpful links from that page:
