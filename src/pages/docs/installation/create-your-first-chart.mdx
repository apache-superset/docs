...
<img src="/static/images/first-chart-fields.png" />
...
<img src="/static/images/first-chart-newChart.png" />

In the Create a new chart screen, select a data source and a visualization type.

<img src="/static/images/first-chart-dataSource.png" />
...
<img src="/static/images/first-chart-chartOption.png" />


With this information, the chart that Superset will process looks like this:

<img src="/static/images/first-chart-plainChart.png" />
...
<img src="/static/images/first-chart-customizeChart.png" />

After the above customizations are applied, the chart looks as follows:

<img src="/static/images/first-chart-barComplete.png" />
...
<img src="/static/images/first-chart-pie.png" />

Or you can try a Treemap as your visualization type:

<img src="/static/images/first-chart-tree.png" />

Or simply select a Table for your visualization type:

<img src="/static/images/first-chart-table.png" />
...
<img src="/static/images/first-chart-save.png" />
