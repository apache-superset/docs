...
As we mentioned earlier, you can repeat this process for every database you want superset to be able to connect to. Here's a list of the recommended package(s) for each database or data engine:

- Amazon Athena: `pip install "PyAthenaJDBC>1.0.9"` or "PyAthena>1.2.0"
...
- Google BigQuery: `pip install pybigquery`
...
- Google Sheets: `pip install gsheetsdb`
...
- Hana: `pip install hdbcli sqlalchemy-hana`
