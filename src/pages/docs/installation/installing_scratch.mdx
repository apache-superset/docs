...
In Ubuntu 18.04 If you have python3.6 installed alongside with python2.7 (which is default on Ubuntu 18.04), run this command also:
...
We highly recommend installing Superset insode of a virtual environment. Python 3 ships with `virtualenv` out of the box but you can install it using:
